...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const users: User[] = [
      ...
      { id: 'jacksonjane4ever', name: 'Jane Jackson', country: 'USA', state: 'LA', city: 'New Orleans', email: 'jackson_jane@outlook.com', password: 'thisisNOTapass', profilePic: '' },
  ...
  const posts : Post[] =[
    { post_id: 1, src: "../assets/users/user4.jpg", date: "", user_id: "pepe_garcia1", alt: ""},
    { post_id: 2, src: "../assets/users/user2.jpg", date: "", user_id: "jacksonjane4ever", alt: ""},
    { post_id: 3, src: "../assets/users/user5.jpg", date: "", user_id: "kroosfriend15", alt: ""},
    { post_id: 4, src: "../assets/users/user3.jpg", date: "", user_id: "dasilva_lukinhas", alt: ""}
  ]
    return {users};
  }
}
